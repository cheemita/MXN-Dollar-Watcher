...
export default class DatosApi4 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.heading}> MXN peso VS UK pound sterlin dollar</Text>
                        ...
                        <View style={styles.dataRow}>
                            ...
                            <Text style={styles.info}>
                                <Image
                                    ...
                                    style={{ width: 30, height: 20 }}
                                />{" "}
                                UK pound sterling: {item["UK pound sterling"]}
                            </Text>
                        </View>
                    )}
                />
