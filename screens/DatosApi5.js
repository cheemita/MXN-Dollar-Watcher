...
export default class DatosApi5 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.heading}> MXN peso VS Japanese yen dollar</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.dataRow}>
                            ...
                            <Text style={styles.info}>
                                <Image
                                    source={require("../img/japo.png")}
                                    style={{ width: 30, height: 20 }}
                                />{" "}
                                Japanese yen: {item["Japanese yen"]}
                            </Text>
                        </View>
                    )}
                />
