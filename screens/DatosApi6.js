...
export default class DatosApi6 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.heading}> MXN peso VS Turkish lira</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.dataRow}>
                            ...
                            <Text style={styles.info}>
                                <Image
                                    source={require("../img/tur.png")}
                                    style={{ width: 30, height: 20 }}
                                />{" "}
                                Turkish lira: {item["Turkish lira"]}
                            </Text>
                        </View>
                    )}
                />
