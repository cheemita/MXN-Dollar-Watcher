...
export default class DatosApi3 extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.heading}> MXN peso VS Canadian dollar</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.dataRow}>
                            ...
                            <Text style={styles.info}>
                                <Image
                                    source={require("../img/can.png")}
                                    style={{ width: 30, height: 20 }}
                                />{" "}
                                Canadian dollar: {item["Canadian dollar"]}
                            </Text>
                        </View>
                    )}
                />
