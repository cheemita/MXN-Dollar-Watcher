...
export default class DatosApi extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <Text style={styles.heading}> MXN peso VS US dollar</Text>
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => (
                        <View style={styles.dataRow}>
                            ...
                            <Text style={styles.info}>
                                <Image
                                    source={require("../img/usa.png")}
                                    style={{ width: 30, height: 20 }}
                                />{" "}
                                US dollar: {item["US dollar"]}
                            </Text>
                        </View>
                    )}
                />
